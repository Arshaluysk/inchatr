				...
				<form action="#" enctype="multipart/form-data" id="edit_poster_form" method="post">
					...
					<?php if ($is_all_posted == 1): ?>
						<style type="text/css">
							...
							.hide_hoye_za_template{
								display: none;
							}
							.hide_hoye_za_group{
								display: none;
							}
							.hide_hoye_za_schedule{
								display: none;	
							}
						</style>
					<?php endif; ?>
					<div class="form-group hide_hoye_za_page col-xs-12 col-md-6" style="padding: 0 1px 0 0 ;">
					...
					<div class="form-group hide_hoye_za_template col-xs-12 col-md-6" style="padding: 0;">
					...
					<div class="form-group hide_hoye_za_group col-xs-12" style="padding: 0 1px 0 0 ;">
						<label>
							<?php echo $this->lang->line("Post to groups");?>
						</label>
						<select multiple="multiple"  class="form-control" id="post_to_groups" name="post_to_groups[]">	
						<?php
						...
						<span class="label label-light red full-documentation"><i class="fa fa-info-circle"></i> <?php echo $this->lang->line("For posting to group, you must need to install the APP in your groups. Click here to read the full instruction."); ?></span>
					</div>	
				<?php endif; ?>
					...
					<div class="form-group hide_hoye_za_schedule">
					...
					<div class="form-group schedule_block_item col-xs-12 col-md-6 hide_hoye_za_schedule">
					...
					<div class="input-group col-xs-12 col-md-12 hide_hoye_za_schedule" style="padding: 0 1px 0 0 ;">
					  <span class="input-group-addon"><?php echo $this->lang->line('repost this post'); ?></span>
					  ...
					  <span class="input-group-addon" id="basic-addon2"><?php echo $this->lang->line('times') ?></span>
					</div>
					<br>
					<div class="form-group hide_hoye_za_schedule">
						...
						<?php
							...
							echo form_dropdown('time_interval',$time_interval,$all_data[0]['time_interval'],' class="form-control" id="time_interval" required');
						?>
					</div>			
	...
	$j("document").ready(function(){
	    ...
	    $("#video_thumb_url_upload").uploadFile({
	     ...
	     $(document.body).on('click','#submit_post',function(){
        	...
        	if(post_to_pages==null && post_to_groups==null)
        	{
        		alertify.alert('<?php echo $this->lang->line("Alert");?>',"<?php echo $this->lang->line('Please select pages or groups to publish this post.');?>",function(){ });
        		return;
        	}
		...
		$(document.body).on('click','.full-documentation',function(){
