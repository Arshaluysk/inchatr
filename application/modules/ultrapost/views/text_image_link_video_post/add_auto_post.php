				...
				<form action="#" enctype="multipart/form-data" id="auto_poster_form" method="post">
					...
					<div class="form-group col-xs-12 col-md-6" style="padding: 0;">
						<label>
							...
							<span class="label label-light pull-right red"><i class="fa fa-info-circle"></i> <?php echo $this->lang->line("page posting."); ?></span>	
						</label>
					...
					<?php if ($facebook_poster_group != '0'): ?>
						<div class="form-group col-xs-12" style="padding: 0 1px 0 0 ;">
							<label>
					...
					<div class="input-group schedule_block_item col-xs-12 col-md-12">
					  <span class="input-group-addon"><?php echo $this->lang->line('repost this post'); ?></span>
					  <input type="number" class="form-control" name="repeat_times" aria-describedby="basic-addon2">
					...
					<div class="form-group schedule_block_item">
						...
						<?php
							...
							echo form_dropdown('time_interval',$time_interval,set_value('time_interval'),' class="form-control" id="time_interval" required');
						?>
					</div>
