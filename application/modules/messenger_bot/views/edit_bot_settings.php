    ...
    <div class="modal-dialog" style="width:100%;margin:20px 0 0 0;">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" style="padding-left: 16px;"><i class='fa fa-edit'></i> <?php echo $this->lang->line("Edit Bot Settings");?> : <a target='_BLANK' href='https://facebook.com/<?php echo $page_info['page_id'];?>'><?php echo $page_info['page_name'];?></a></h4>
        </div>
        <div class="modal-body" style="padding-left:30px;"> 
          ...
          <?php } ?>
                ...
                <div class="row">
                  <div class="col-xs-6">
                     <br><button id="submit" class="btn btn-lg btn-primary"><i class="fa fa-edit"></i> <?php echo $this->lang->line('Update'); ?></button>
                  </div>
