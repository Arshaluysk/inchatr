  ...
  <div class="modal-dialog  modal-lg" style="width: 96%;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-list"></i> <?php echo $this->lang->line("Persistent Menu");?> [<a href="https://facebook.com/<?php echo $page_info['page_id'];?>"><?php echo $page_info['page_name'];?></a>]</h4>
      </div>
      <div class="modal-body">
        <form id="messenger_bot_form">
          ...
          { ?>
            ...
            for($i=1;$i<=$level1;$i++)
            { ?>             
                <div class="level1<?php if($i>1) echo ' hidden';?>" id="text_with_buttons_row_<?php echo $i; ?>">
                ...
                for($j=1;$j<=$level2;$j++)
                { ?>
                    <div class="level2<?php if($j>0) echo ' hidden';?>" id="text_with_buttons_row_<?php echo $i; ?>_<?php echo $j;?>">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-md-4">
                          <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>_<?php echo $j;?>" style="display: none;">
                            <!-- <input type="text" class="form-control" placeholder="<?php echo $this->lang->line("PostBack id"); ?>" name="text_with_button_post_id_<?php echo $i; ?>_<?php echo $j;?>" id="text_with_button_post_id_<?php echo $i; ?>_<?php echo $j;?>"> -->
                    ...
                    for($k=1;$k<=$level3;$k++)
                    { ?>
                      <div class="level3<?php if($k>0) echo ' hidden';?>" id="text_with_buttons_row_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-md-4">
                            <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>" style="display: none;">
                              <!-- <input type="text" class="form-control" placeholder="<?php echo $this->lang->line("PostBack id"); ?>" name="text_with_button_post_id_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>" id="text_with_button_post_id_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>"> -->
                    ...
                    <a style="border-radius: 0;" class="btn btn-xs btn-outline-primary pull-right level3_add hidden" id="add_more_<?php echo $i?>_<?php echo $j?>"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("level-3 menu"); ?></a>
                    <a style="border-radius: 0;margin-right:2px;" class="btn btn-xs btn-outline-danger pull-right level3_remove hidden" id="remove_menu_<?php echo $i?>_<?php echo $j?>"><i class="fa fa-remove"></i>  <?php echo $this->lang->line("remove"); ?></a>
                    <div class="clearfix"></div>
                  </div> <!-- level2 end -->                  
                  <?php
                } ?>
                <a style="border-radius: 0;" class="btn btn-sm btn-outline-primary pull-right level2_add hidden" id="add_more_<?php echo $i?>"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("level-2 menu"); ?></a>
                <a style="border-radius: 0;margin-right:2px;" class="btn btn-sm btn-outline-danger pull-right level2_remove hidden" id="remove_menu_<?php echo $i?>"><i class="fa fa-remove"></i>  <?php echo $this->lang->line("remove"); ?></a>
                <div class="clearfix"></div>
              </div> <!-- leve1 end -->
            <?php
            } ?>
            <a style="border-radius: 0;" class="btn btn-outline-primary pull-right" id="add_more"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("level-1 menu"); ?></a>
            <a style="border-radius: 0;margin-right:2px;" class="btn btn-outline-danger pull-right hidden" id="remove_menu" style="margin-right:5px"><i class="fa fa-remove"></i> <?php echo $this->lang->line("remove"); ?></a>
            <div class="clearfix"></div>
