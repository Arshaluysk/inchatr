...
<script type="text/javascript">
  ...
  {     
     for (var i = 1; i <= text_with_button_counter_level1; i++) 
     {
        ...
        {
          $("#error_modal_content").html("<?php echo $this->lang->line('missing menu title : leve1-1 menu')?>");
          $("#error_modal").modal();
          return false;
        }
        ...
        {
          $("#error_modal_content").html("<?php echo $max_length?>");
          $("#error_modal").modal();
          return false;
        }
        ...
        {
          $("#error_modal_content").html("<?php echo $this->lang->line('missing menu type : leve1-1 menu')?>");
          $("#error_modal").modal();
          return false;
        }
        else if(text_with_button_type_check == 'post_back')
        {
          ...
          if(text_with_button_post_id_check == ''){
            $("#error_modal_content").html("<?php echo $this->lang->line('missing menu postback ID : leve1-1 menu')?>");
            $("#error_modal").modal();
            return false;
          }
        ...
        {          
          ...
          if(text_with_button_counter_level2>=1)
          {
            for (var j = 1; j <= text_with_button_counter_level2; j++) 
            {
              ...
              {
                $("#error_modal_content").html("<?php echo $this->lang->line('missing menu title : leve1-2 menu')?>");
                $("#error_modal").modal();
                return false;
              }
              ...
              {
                $("#error_modal_content").html("<?php echo $this->lang->line('missing menu type : leve1-2 menu')?>");
                $("#error_modal").modal();
                return false;
              }
              else if(text_with_button_type_check2 == 'post_back')
              {
                ...
                if(text_with_button_post_id_check2 == ''){
                  $("#error_modal_content").html("<?php echo $this->lang->line('missing menu postback ID : leve1-2 menu')?>");
                  $("#error_modal").modal();
                  return false;
                }
              ...
              {                
                ...
                if(text_with_button_counter_level3>=1)
                {
                  for (var k = 1; k <= text_with_button_counter_level3; k++) 
                  {
                    ...
                    {
                      $("#error_modal_content").html("<?php echo $this->lang->line('missing menu title : leve1-3 menu')?>");
                      $("#error_modal").modal();
                      return false;
                    }
                    ...
                    {
                      $("#error_modal_content").html("<?php echo $this->lang->line('missing menu type : leve1-3 menu')?>");
                      $("#error_modal").modal();
                      return false;
                    }
                    else if(text_with_button_type_check3 == 'post_back')
                    {
                      ...
                      if(text_with_button_post_id_check3 == ''){
                        $("#error_modal_content").html("<?php echo $this->lang->line('missing menu postback ID : leve1-3 menu')?>");
                        $("#error_modal").modal();
                        return false;
                      }
  ...
  $j(document.body).on('click','#add_more',function(e){ // add new level 1 menu
      e.preventDefault();
      if(validation())   
      {
  ...
  $j(document.body).on('click','.level2_add',function(e){ // add new level 2 menu
      e.preventDefault();
      if(validation()) 
      {
  ...
  $j(document.body).on('click','.level3_add',function(e){ // add new leve3 menu
      e.preventDefault();
      if(validation()) 
      {
        var add_button_id=$(this).attr('id');
  ...
  $j(document.body).on('click','#remove_menu',function(e){ // remove level 1 menu
      e.preventDefault();      
  ...
  $j(document.body).on('click','.level2_remove',function(e){ // remove level 2 menu
      e.preventDefault();     
  ...
  $j(document.body).on('click','.level3_remove',function(e){ // remove leve3 menu
      e.preventDefault();
      var remove_button_id=$(this).attr('id');
  ...
  $j(document.body).on('click','.text_with_button_type_class_level1',function() {
  ...
  var previous_val2="";
  var now_id2="";
  $j(document.body).on('click','.text_with_button_type_class_level2',function() {
  ...
  var previous_val3="";
  var now_id3="";
  $j(document.body).on('click','.text_with_button_type_class_level3',function() {
      ...
      var queryString = new FormData($("#messenger_bot_form")[0]);
        $.ajax({
          ...
          success:function(response){
              ...
              window.location.assign(base_url+"messenger_bot/persistent_menu_list/"+page_table_id);
              else 
              {
                $("#submit_status").addClass("alert alert-danger").html(response.message);
  ...
  <div class="modal-dialog  modal-lg" style="width: 96%;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i> <?php echo $this->lang->line("Edit Persistent Menu");?> [<a href="https://facebook.com/<?php echo $page_info['page_id'];?>"><?php echo $page_info['page_name'];?></a>]</h4>
      </div>
        ...
        <form id="messenger_bot_form">
          ...
          { ?>
            ...
            { 
              ...
              ?>             
                <div class="level1<?php if(!isset($item_json_array["call_to_actions"][$i])) echo ' hidden';?>" id="text_with_buttons_row_<?php echo $i; ?>">
                  <h1 class='text-center level1_title'><?php echo $this->lang->line("level-1 menu");?></h1> 
                  <div class="row">
                    <div class="col-xs-12 col-md-4">
                      <div class="form-group">
                    ...
                    <div class="col-xs-12 col-md-4">
                      <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>" <?php if($level1_xtype!='post_back') echo 'style="display: none;"'; ?>>
                        <!-- <input value="<?php echo $level1_xpostback;?>" type="text" class="form-control" placeholder="<?php echo $this->lang->line("PostBack id"); ?>" name="text_with_button_post_id_<?php echo $i; ?>" id="text_with_button_post_id_<?php echo $i; ?>"> -->
                ...
                { 
                  ...
                  ?>
                    <div class="level2<?php if(!isset($item_json_array["call_to_actions"][$i]["call_to_actions"][$j])) echo ' hidden';?> echo ' hidden';?>" id="text_with_buttons_row_<?php echo $i; ?>_<?php echo $j;?>">
                      <h2 class='text-center level2_title'><?php echo $this->lang->line("level-2 menu");?></h2>
                      <div class="row">
                        <div class="col-xs-12 col-md-4">
                          <div class="form-group">
                    ...
                    { 
                      ...
                      ?>
                      <div class="level3<?php if(!isset($item_json_array["call_to_actions"][$i]["call_to_actions"][$j]["call_to_actions"][$k])) echo ' hidden';?>" id="text_with_buttons_row_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>">
                        <h3 class='text-center level3_title'><?php echo $this->lang->line("level-3 menu");?></h3>
                        <div class="row">
                          <div class="col-xs-12 col-md-4">
                            <div class="form-group">
                          ...
                          <div class="col-xs-12 col-md-4">
                            <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>" <?php if($level3_xtype!='post_back') echo 'style="display: none;"'; ?>>
                              <!-- <input value="<?php echo $level3_xpostback;?>" type="text" class="form-control" placeholder="<?php echo $this->lang->line("PostBack id"); ?>" name="text_with_button_post_id_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>" id="text_with_button_post_id_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>"> -->
                    ...
                    <a style="border-radius: 0;" class="btn btn-xs btn-outline-primary pull-right level3_add <?php echo $level3_add_hide;?>" id="add_more_<?php echo $i?>_<?php echo $j?>"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("level-3 menu"); ?></a>
                    <a style="border-radius: 0;margin-right:2px;" class="btn btn-xs btn-outline-danger pull-right level3_remove  <?php echo $level3_remove_hide;?>" id="remove_menu_<?php echo $i?>_<?php echo $j?>"><i class="fa fa-remove"></i> <?php echo $this->lang->line("remove"); ?></a>
                    <div class="clearfix"></div>
                  </div> <!-- level2 end -->                  
                  <?php
                } ?>
                ...
                <a style="border-radius: 0;" class="btn btn-sm btn-outline-primary pull-right level2_add <?php echo $level2_add_hide;?>" id="add_more_<?php echo $i?>"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("level-2 menu"); ?></a>
                <a style="border-radius: 0;margin-right:2px;" class="btn btn-sm btn-outline-danger pull-right level2_remove <?php echo $level2_remove_hide;?>" id="remove_menu_<?php echo $i?>"><i class="fa fa-remove"></i> <?php echo $this->lang->line("remove"); ?></a>
                <div class="clearfix"></div>
              </div> <!-- leve1 end -->
            <?php
            } ?>

            <a style="border-radius: 0;" class="btn btn-outline-primary pull-right <?php if($text_with_button_counter_level1_js>=$level1) echo 'hidden';?>" id="add_more"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("level-1 menu"); ?></a>
            <a style="border-radius: 0;margin-right:2px;" class="btn btn-outline-danger pull-right <?php if($text_with_button_counter_level1_js<=1) echo 'hidden';?>" id="remove_menu"><i class="fa fa-remove"></i> <?php echo $this->lang->line("remove"); ?></a>
            <div class="clearfix"></div>
