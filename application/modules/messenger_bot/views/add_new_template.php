...
<div class="container-fluid">
   <div id="add_bot_settings_modal">
    <div class="modal-dialog" style="width:100%;margin:20px 0 0 0;">
      <div class="modal-content">
        <div class="modal-header hidemeplz">
          <h4 class="modal-title" style="padding-left: 16px;"><i class='fa fa-plus-circle'></i> <?php echo $this->lang->line("Add template for postback");?></h4>
        </div>
        <div class="modal-body" style="padding-left:30px;"> 
          <div class="row">
            <div class="<?php if($is_iframe=="1") echo 'col-xs-12'; else echo 'col-xs-12 col-md-9';?>">
              <form action="#" method="post" id="messenger_bot_form" style="padding-left: 0;">
                  ...
                  <div class="col-xs-12"> 
                    <div class="form-group">
                      ...
                      <?php 
                      	...
                      	echo form_dropdown('page_table_id',$page_list,$default_page,'id="page_table_id" class="form-control"'); 
                      ?>
                    </div>       
                  </div>  
                </div>
                ...
                <div class="row"> 
                  <div class="col-xs-12"> 
                    <div class="form-group">
                      <label><?php echo $this->lang->line("Please give a postback ID"); ?></label>
                      <input type="text" name="template_postback_id" id="template_postback_id" class="form-control push_postback">
                    </div>       
                  </div>  
                </div>
                ...
                if($this->is_broadcaster_exist)
                {
                      ...
                      echo '<div class="row">
                      <div class="col-xs-12 hidden dropdown_con"> 
                          <div class="form-group">
          ...
          <div id="multiple_template_div_<?php echo $k; ?>" <?php if($k != 1) echo "style='display : none; margin-top:20px;background:#fff; border:.8px dashed ".$THEMECOLORCODE.";'"; else echo "style='margin-top:20px;background:#fff; border:.8px dashed ".$THEMECOLORCODE.";'"; ?>>            
                    ...
                    <div class="row" id="media_row_<?php echo $i; ?>_<?php echo $k; ?>" style="display: none;border:1px dashed #ccc; background: #fcfcfc;padding:10px;margin:5px 0 0 20px;">
                      ...
                      <div class="col-xs-12 col-md-3">
                        <div class="form-group" id="media_postid_div_<?php echo $i; ?>_<?php echo $k; ?>" style="display: none;">
                          ...
                          <input type="text" class="form-control push_postback"  name="media_post_id_<?php echo $i; ?>_<?php echo $k; ?>" id="media_post_id_<?php echo $i; ?>_<?php echo $k; ?>" value="" >
            ...
            <div class="hidden-xs hidden-sm col-md-3 img_holder <?php if($is_iframe=="1") echo 'hidden';?>" style="" >
...
<script type="text/javascript">
  $(document).ready(function(e){
    $( document ).on( 'click', '.bs-dropdown-to-select-group .dropdown-menu li', function( event ) {
     ...
     $(document.body).on('change','#page_table_id',function(){     
        var page_id=$(this).val();
        if(page_id=='') return;
        var is_broadcaster_exist='<?php echo $is_broadcaster_exist;?>';
        if(is_broadcaster_exist==false) return;
...
<?php for($template_type=1;$template_type<=3;$template_type++){ ?>
    ...
    $(document.body).on('click','#submit',function(e){   
      ...
      if(bot_name == '')
      {
        $("#error_modal_content").html("<?php echo $this->lang->line('Please Give Template Name')?>");
        $("#error_modal").modal();
        return;
      }
        ...
        $.ajax({
          ...
          success:function(response){
            ...
            if(is_iframe=='1') 
            {
              ...
              $("#submit_status").removeClass('alert').removeClass('alert-success').removeClass('alert-danger').html('');
              alertify.alert('<?php echo $this->lang->line("Alert"); ?>',"<?php echo $this->lang->line('Template has been created successfully.'); ?>",function(){});
            }
