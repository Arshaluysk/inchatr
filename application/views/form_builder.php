<!--         <link href="<?php echo base_url();?>plugins/form_builder/css/bootstrap.min.css" rel="stylesheet">
        <link href="<?php echo base_url();?>plugins/form_builder/css/bootstrap-theme.min.css" rel="stylesheet"> -->
        <link href="<?php echo base_url();?>plugins/form_builder/css/codemirror.css" rel="stylesheet">
        <link href="<?php echo base_url();?>plugins/form_builder/css/form_builder.css" rel="stylesheet">
        <!-- Options Modal -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                        ...
                        <div id="components-container" class="form-horizontal">
                            ...
                            <div class="component form-group" data-type="date_time">
                                <label class="control-label col-sm-4" for="text_input">Date Time Picker</label>
                                <div class="controls col-sm-8">
                                    <input type="text" name="" id="text_input" placeholder="time" class="form-control datepicker">
                                </div>
                            </div>
...
<!--         <script src="<?php echo base_url();?>plugins/form_builder/js/jquery.min.js"></script>
        <script src="<?php echo base_url();?>plugins/form_builder/js/jquery-ui.min.js"></script>
        <script src="<?php echo base_url();?>plugins/form_builder/js/bootstrap.min.js"></script> -->
        <script src="<?php echo base_url();?>plugins/form_builder/js/form_builder.js"></script>
        <script src="<?php echo base_url();?>plugins/form_builder/js/codemirror.min.js"></script>
        <script src="<?php echo base_url();?>plugins/form_builder/js/formatting.js"></script>