                    ...
                    <div class="header-container">
                        <ul class="nav-left">
                          ...
                          <span>Post</span>
                                            ...
                                            <ul class="list-unstyled list-info">
                                                <li>
                                                    <a href="">
                                                        <img class="thumb-img" src="<?php echo base_url();?>new_assets/images/img-1.jpg" alt="">
                                                        <div class="info">
                                  ...
                                  <span>Oh, thank goodness we're coming out...</span>
                                                ...
                                                <li>
                                                    <a href="">
                                                        <img class="thumb-img" src="<?php echo base_url();?>new_assets/images/img-2.jpg" alt="">
                                                        <div class="info">
                        ...
                        <ul class="nav-right">
                            <li class="user-profile dropdown">
                                <a href="<?php echo base_url('member/edit_profile') ?>" class="dropdown-toggle" data-toggle="dropdown">
                                    <img class="profile-img img-fluid" src="<?php echo $this->session->userdata("brand_logo"); ?>" >
                                    <div class="user-info">
                                        <span class="name pdd-right-5"><?php echo $this->session->userdata("username");?></span>
                                ...
                                <div class="chat">
                                    <div class="chat-user-list scrollable">
                                        <div class="chat-section">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo base_url();?>new_assets/images/avatars/thumb-2.jpg" alt="">
                                                <div class="user-info">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo base_url();?>new_assets/images/avatars/thumb-3.jpg" alt="">
                                                <div class="user-info">
                                        ...
                                        <div class="chat-section">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo base_url();?>new_assets/images/avatars/thumb-10.jpg" alt="">
                                                <div class="user-info">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo base_url();?>new_assets/images/avatars/thumb-11.jpg" alt="">
                                                <div class="user-info">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo base_url();?>new_assets/images/avatars/thumb-9.jpg" alt="">
                                                <div class="user-info">
                                            ...
                                            <div class="text-center mrg-top-20">
                                                <div class="row">
                                                    <div class="col-md-6 ml-auto mr-auto text-center">
                                                        <img class="img-fluid border-radius-round" src="<?php echo base_url();?>new_assets/images/avatars/user-1.jpg" alt="">
                                                    </div>
                                                </div>
